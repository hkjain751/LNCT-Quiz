<%-- 
    Document   : newaddques
    Created on : 31 Mar, 2018, 3:04:00 PM
    Author     : hp
--%>
...
<head>
  <meta charset="UTF-8">
  <title>LNCT Quiz|ADD QUESTION</title>
   <% 
...
<body>
  ...
  <div class="form">
      ...
      <form class="login-form" method="post" action="addnewques.jsp">
       <h3>ADD QUESTION</h3>
       ...
       <select name="item" style="font-family:Roboto,sans-serif; outline: 0; background: #f2f2f2; width: 100%; border: 1px; margin: 0 0 15px; padding: 15px; box-sizing: border-box; font-size: 14px;">
          <option value="null">Select Question Paper</option>
          <%    try {
                Class.forName("oracle.jdbc.driver.OracleDriver");
                Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","hkjain751");
                PreparedStatement ps=con.prepareStatement("select subjectcode from lnctquizinfo where addedby=?");
