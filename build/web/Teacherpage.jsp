<%-- 
    ...
    Created on : 26 Mar, 2018, 10:39:53 PM
    Author     : hp
--%>
...
<section id="home" class="home">
            <div class="overlay">
                ...
                <center>
                    ...
                    <input type="submit" value="ADD QUIZ" name="ADD QUIZ" style=" background-color: transparent; font-family: sans-serif; font-size: 20px; color: whitesmoke; border-color:  transparent;"/>
                    </form><hr>
                    <form action="addstudent.jsp">
                    <input type="submit" value="ADD STUDENT" name="ADD STUDENT" style=" background-color: transparent; font-family: sans-serif; font-size: 20px; color: whitesmoke; border-color:  transparent;"/>
                    </form><hr>
                    <form action="editquiz.jsp" >
                    <input type="submit" value="EDIT QUIZ" name="EDIT QUIZ" style=" background-color: transparent; font-family: sans-serif; font-size: 20px; color: whitesmoke; border-color:  transparent;"/>
                    </form>
                    <hr>
                    <form action="newaddques.jsp"  >
                    <input type="submit" value="ADD QUESTION IN QUIZ" name="ADD QUESTION IN QUIZ" style=" background-color: transparent; font-family: sans-serif; font-size: 20px; color: whitesmoke; border-color:  transparent;"/>
                    </form><hr>
                    <form action="seeresult.jsp"  >
